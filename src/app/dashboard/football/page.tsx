...
const matches: Match[] = [
  {
    leagueBg: "Англия - Premier League",
    leagueEn: "England - Premier League",
    home: "Arsenal",
    away: "Liverpool",
    start: "15:00",
  },
  {
    leagueBg: "България - Първа лига",
    leagueEn: "Bulgaria - First League",
    home: "Лудогорец",
    away: "Левски",
    start: "17:30",
  },
  {
    leagueBg: "Испания - La Liga",
    leagueEn: "Spain - La Liga",
    home: "Real Madrid",
    away: "Barcelona",
    start: "21:00",
  },
            ...
            >
              <div className="flex items-center justify-between gap-3">
                <span className="rounded-full bg-slate-800 px-3 py-1 text-xs font-semibold text-slate-300">
                  {language === "bg" ? match.leagueBg : match.leagueEn}
                </span>
              ...
              <p className="mt-1 text-sm text-slate-500">{t.minimum}</p>
