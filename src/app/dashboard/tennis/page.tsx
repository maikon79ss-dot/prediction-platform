...
const matches: TennisMatch[] = [
  {
    tournamentBg: "ATP 500",
    tournamentEn: "ATP 500",
    player1: "Grigor Dimitrov",
    player2: "Novak Djokovic",
    start: "17:30",
  },
  {
    tournamentBg: "WTA 1000",
    tournamentEn: "WTA 1000",
    player1: "Aryna Sabalenka",
    player2: "Iga Swiatek",
    start: "19:00",
  },
  {
    tournamentBg: "ATP Masters",
    tournamentEn: "ATP Masters",
...
const longTermMarkets = [
  {
    bg: "Кой ще спечели Wimbledon?",
    en: "Who will win Wimbledon?",
  },
  {
    bg: "Кой ще спечели US Open?",
    en: "Who will win the US Open?",
  },
  {
    bg: "Кой ще спечели Roland Garros?",
    en: "Who will win Roland Garros?",
  },
  {
    bg: "Кой ще спечели Australian Open?",
    en: "Who will win the Australian Open?",
  },
];
...
export default function TennisPage() {
  ...
  const t =
    language === "bg"
      ? {
          title: "Тенис",
          subtitle: "Предстоящи тенис прогнози",
          ...
          tournaments: "Турнири",
          longTerm: "Дългосрочни тенис прогнози",
          longTermMinimum: "Минимум: 1 000 точки",
          view: "Виж пазара",
        }
      : {
          title: "Tennis",
          subtitle: "Upcoming tennis predictions",
          ...
          longTerm: "Long-term tennis predictions",
